...
CREATE OR REPLACE FUNCTION "public"."accept_ledger_invite"("p_token" "text") RETURNS TABLE("ledger_id" "uuid", "ledger_name" "text", "result" "text", "placeholder_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'pg_temp'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."create_ledger_invite_v2"("p_ledger_id" "uuid", "p_role" "text" DEFAULT 'member'::"text", "p_placeholder_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("invite_id" "uuid", "token" "text", "ledger_name" "text", "invite_role" "text", "placeholder_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'pg_temp'
    AS $$
#variable_conflict use_column
...
ALTER FUNCTION "public"."create_ledger_invite_v2"("p_ledger_id" "uuid", "p_role" "text", "p_placeholder_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_linked_transaction_edit"("p_ledger_id" "uuid", "p_transaction_record_id" "uuid", "p_transaction_at" timestamp with time zone, "p_merchant_id" "uuid", "p_note" "text", "p_item_updates" "jsonb") OWNER TO "postgres";
...
REVOKE ALL ON FUNCTION "public"."create_ledger_invite_v2"("p_ledger_id" "uuid", "p_role" "text", "p_placeholder_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."create_ledger_invite_v2"("p_ledger_id" "uuid", "p_role" "text", "p_placeholder_id" "uuid") TO "authenticated";
...
REVOKE ALL ON FUNCTION "public"."update_linked_transaction_edit"("p_ledger_id" "uuid", "p_transaction_record_id" "uuid", "p_transaction_at" timestamp with time zone, "p_merchant_id" "uuid", "p_note" "text", "p_item_updates" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."update_linked_transaction_edit"("p_ledger_id" "uuid", "p_transaction_record_id" "uuid", "p_transaction_at" timestamp with time zone, "p_merchant_id" "uuid", "p_note" "text", "p_item_updates" "jsonb") TO "authenticated";
