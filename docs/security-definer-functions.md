...
- Issue #551 新增的 3 个函数也直接声明 `pg_catalog, pg_temp`。
...
| `validate_transaction_item_special_status`              | `pg_catalog, pg_temp` | 无                                                     | PUBLIC 撤销                        | 触发器：`transaction_item_validate_special_status`                                                                                                                                                                                                                               |
