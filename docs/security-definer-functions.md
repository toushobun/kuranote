...
| `validate_linked_transaction_item_mutation`             | `pg_catalog, pg_temp` | 无                                                     | PUBLIC 撤销                        | 触发器：`transaction_item_validate_linked_amount`、`transaction_item_prevent_linked_delete`                                                                                                                                                                                       |
