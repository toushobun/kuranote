import type { AuthOtpAttempt, AuthOtpPurpose } from "server/auth/entity/auth";
import { RepositoryError } from "server/shared/errors/appError";
import type { Logger } from "server/shared/logging/logger";
import { createServiceRoleSupabaseClient } from "server/shared/supabase/serviceRoleClient";
