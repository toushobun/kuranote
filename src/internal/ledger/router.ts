...
ledgerRouter.use("*", sameOriginMiddleware);
ledgerRouter.openapi(createLedgerRoute, createLedgerHandler);
ledgerRouter.openapi(switchCurrentLedgerRoute, switchCurrentLedgerHandler);
ledgerRouter.openapi(updateLedgerSettingsRoute, updateLedgerSettingsHandler);
ledgerRouter.openapi(createLedgerInviteRoute, createLedgerInviteHandler);
ledgerRouter.openapi(revokeLedgerInviteRoute, revokeLedgerInviteHandler);
