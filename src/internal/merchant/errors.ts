...
const merchantErrorMessages: Record<MerchantErrorCode, string> = {
  ...
  [merchantErrorCodes.merchantTagArchiveFailed]: "分类归档失败，请稍后重试。",
  [merchantErrorCodes.merchantTagCreateFailed]:
    "分类新增失败。请确认分类名称是否重复，或稍后重试。",
  [merchantErrorCodes.merchantTagIconInvalid]: "请选择分类图标。",
  [merchantErrorCodes.merchantTagInvalid]: "该商家分类不存在或已不可用。",
