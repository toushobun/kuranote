...
import type { CategoryData } from "internal/category/repository/categoryRepository";

type CategoryTreeItem = CategoryData & {
  children: CategoryData[];
};

function buildCategoryTree(categories: CategoryData[]): CategoryTreeItem[] {
