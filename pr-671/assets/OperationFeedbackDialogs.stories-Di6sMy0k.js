import{i as e}from"./preload-helper-D2yxXLVK.js";import{t}from"./jsx-runtime-Dwpk6tgA.js";import{n,t as r}from"./Box-C73jOCIQ.js";import{n as i,t as a}from"./UserThemeProvider-CeP1xXfO.js";import{a as o,i as s,n as c,o as l,r as u}from"./OperationFeedbackDialogs-CaBj-4C8.js";var d,f,p,m,h,g,_;e((()=>{d=t(),r(),i(),l(),f={title:`Molecules/UI/OperationFeedbackDialogs`,decorators:[e=>(0,d.jsx)(a,{storageScope:`storybook-operation-feedback-dialog`,children:(0,d.jsx)(e,{})})]},p={name:`成功反馈`,render:()=>(0,d.jsx)(o,{description:`这条记录已经保存，可以继续记录生活。`,onClose:()=>void 0,open:!0,title:`保存成功`})},m={name:`失败反馈`,render:()=>(0,d.jsx)(s,{description:`请稍后再试，或检查网络连接。`,onClose:()=>void 0,open:!0,title:`保存失败`})},h={name:`删除确认`,render:()=>(0,d.jsx)(u,{description:`删除后无法恢复。`,onCancel:()=>void 0,onConfirm:()=>void 0,open:!0,title:`确认删除这条记录？`})},g={name:`自定义确认内容`,render:()=>(0,d.jsx)(c,{cancelLabel:`稍后再说`,confirmLabel:`继续`,description:`确认后会进入下一步。`,illustration:(0,d.jsx)(n,{"aria-hidden":`true`,sx:{bgcolor:`var(--user-theme-badge-bg)`,borderRadius:`50%`,height:72,width:72}}),onCancel:()=>void 0,onConfirm:()=>void 0,open:!0,title:`继续这个操作？`})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: "成功反馈",
